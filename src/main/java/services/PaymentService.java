...
public class PaymentService {
    ...
    public List<PaymentOfCourse> paymentsOfCourse(int courseId){
        Session session  = sf.openSession();
        Transaction transaction = session.beginTransaction();
    ...
    public Map<String, List<PaymentOfCourse>> paymentsOfUser(int userId){

        HashMap<String, List<PaymentOfCourse>> result = new HashMap<>();
        final Collection<Course> courses = this.courseService.getCoursesPublishedBy(userId);

        courses.forEach(course ->{
            final List<PaymentOfCourse> paymentsOfCourse = paymentsOfCourse(course.getId());
            result.put(course.getName(), paymentsOfCourse);
